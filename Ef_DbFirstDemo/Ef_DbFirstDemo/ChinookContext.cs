    ...
    public partial class ChinookContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee1>(entity =>
            {
                ...
                entity.ToTable("Employee", "SuperStore");

                entity.HasIndex(e => e.DeptId, "UQ__Employee__0148818FE9B62A5B")
                    .IsUnique();

                entity.HasIndex(e => e.Id, "UQ__Employee__3214EC260E9B8017")
                    .IsUnique();

                entity.HasIndex(e => e.Ssn, "UQ__Employee__CA1E8E3CA7F605D5")
                    .IsUnique();
